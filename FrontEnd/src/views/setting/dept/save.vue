		...
		submit() {
			this.$refs.dialogForm.validate(async (valid) => {
				if (valid) {
					...
					this.$API.department.deleteDepartments.post


					var res
					if (this.mode == 'add') {
						res = await this.$API.department.addDepartment.post(this.form);
					} else {
						res = await this.$API.department.updateDepartment.post(this.form);
					}
